                            ...
                            <FadeInUp>
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="flex pt-3">
                                        <img src={`http://localhost:1337${article.author.picture.url}`} className="w-10 h-10 rounded-full" />
                                        <div className="flex flex-col pl-1">
                                            <span className="text-xs">
                                            {article.author.name ? article.author.name : (article.author.firstname.substr(0,1).toUpperCase() + article.author.firstname.substr(1, article.author.firstname.length) + " " + article.author.lastname)}
                                            </span>
